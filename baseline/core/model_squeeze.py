...
from core import resnet, densenet, resnext, mobilenet, squeezenet
import numpy as np
...
class attention_net(nn.Module):
    def __init__(self, topN=4, classNum=200):
        ...
        self.pretrained_model = squeezenet.squeezenet1_1(pretrained=True,num_classes=classNum)
        ...
        self.edge_anchors = (edge_anchors + 224).astype(np.int).repeat(4,0)[:5991,:]
    ...
    def forward(self, x):
        ...
        # print("part_feature {} feature {}".format(part_feature.shape,feature.shape))   (8, 8192) (8, 2048)
        concat_out = torch.cat([part_feature, torch.squeeze(feature)], dim=1)
