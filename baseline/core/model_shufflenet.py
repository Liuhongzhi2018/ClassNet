...
from core import resnet,shufflenetv2
import numpy as np
...
class attention_net(nn.Module):
    def __init__(self, topN=4,classNum=20):
        ...
        self.pretrained_model = shufflenetv2.shufflenet_v2_x1_0(pretrained=True,num_classes=classNum)
        ...
        self.pad_side = 224
        self.edge_anchors = (edge_anchors + 224).astype(np.int).repeat(251,0)[:404544,:]
